...
const DashChart =  () => {
  ...
  useEffect(() => {
    ...
    const echartDash2 = document.getElementById('echarts-dash-2')
    ...
    echarts.init(echartDash2).setOption({
      color: colors,
  ...
  return (<div className="dash-chart">
    ...
    <div id="echarts-dash-2" className={classNames(style['echarts-dash-2'])}></div>
  </div>)
}
